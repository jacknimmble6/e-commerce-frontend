...
const RandomCategory = ({ c }) => {
  ...
  return (
    <div className="absolute top-[644px] left-[60px] w-[1200px] h-[500px] font-['Sora']">
      ...
      <div className='grid grid-cols-3 gap-0 w-[1370px] 2xl:w-[1650px]'>
      {random.map(r => (
        <div className='w-[380px] 2xl:w-[480px] h-fit text-center shadow-[4px_4px_4px_4px_rgba(0,0,0,0.35)]
         bg-white'>
          <Link to={`/product/detail/${r._id}`}>
            <img src={r.images[0]} alt='' className='h-[200px] 2xl:w-[480px] w-[380px] object-cover'/>
