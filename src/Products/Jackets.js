  ...
  return (
    ...
    <div>
      <img src={randomImage.images === undefined ? '' : randomImage.images[0]} key={randomImage._id} 
       alt="" className="h-[550px] 2xl:w-[1580px] ml-16 mt-24 w-[1300px] "/>
        

      <div className="grid grid-cols-3 mt-16 2xl:w-[1580px] w-[1370px]">
        {jackets.map(product => (
          <div className="w-[360px] h-fit left-[0px] top-[-44px] ml-16 mt-8 2xl:w-[510px]
